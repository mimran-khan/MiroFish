...
Persists project state on the server so the client does not pass large payloads across API calls.
"""
...
class Project:
    ...
    # Ontology (filled after API 1)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None
    
    # Graph (filled after API 2)
...
class ProjectManager:
    """Persist and load projects from disk."""
    ...
    def save_file_to_project(cls, project_id: str, file_storage, original_filename: str) -> Dict[str, str]:
        """
        Save an uploaded file into the project folder.
        ...
        Returns:
            Dict with filename, path, size, etc.
        """
        files_dir = cls._get_project_files_dir(project_id)
        os.makedirs(files_dir, exist_ok=True)
    ...
    def save_extracted_text(cls, project_id: str, text: str) -> None:
        """Write extracted plain text for the project."""
    ...
    def get_extracted_text(cls, project_id: str) -> Optional[str]:
        """Read extracted plain text if present."""
        text_path = cls._get_project_text_path(project_id)
    ...
    def get_project_files(cls, project_id: str) -> List[str]:
        """Absolute paths of all files in the project upload folder."""
        files_dir = cls._get_project_files_dir(project_id)
