...
class SimulationLogManager:
    """
    Central log manager for simulations.

    Manages all log files, split by platform.
    """
    ...
    def __init__(self, simulation_dir: str):
        ...
        # Configure main simulation log
        self._setup_main_logger()

    def _setup_main_logger(self):
        """Configure the main simulation log file and console handler."""
    ...
    def log(self, message: str, level: str = "info"):
        """Write to the main simulation log."""
