"""
OASIS Twitter simulation driver.
...
Usage:
    ...
    python run_twitter_simulation.py --config /path/to/simulation_config.json --no-wait  # exit immediately after run
"""
...
class TwitterSimulationRunner:
    """Runs a Twitter OASIS simulation from config."""
    ...
    def _get_profile_path(self) -> str:
        """Path to twitter_profiles.csv (OASIS Twitter CSV)."""
