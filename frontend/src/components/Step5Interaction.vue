          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">Choose chat target</div>
                <div 
            ...
            >
              ...
              <span>Send questionnaire to the world</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Fast chat with the report agent, four tools, full MiroFish memory.</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seeds with simulated state using global/local memory for cross-time attribution.</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Graph BFS to reconstruct propagation paths and information-flow topology.</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-backed lookup for node attributes and discrete facts.</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Parallel multi-turn interviews with agents for unstructured views and stance.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent about the report.' : 'Chat with agents about their views.' }}
              </p>
            </div>
            <div 
...
const chatHistoryCache = ref({}) // Per-target chat threads
...
const selectAgent = (agent, idx) => {
  ...
  addLog(`Chat target: ${agent.username}`)
}
...
const renderMarkdown = (content) => {
  ...
  // Trim after ul/ol open
  html = html.replace(/<ul class="md-ul">\s+/g, '<ul class="md-ul">')
  html = html.replace(/<ol class="md-ol">\s+/g, '<ol class="md-ol">')
  // Trim before ul/ol close
  ...
  // Drop leading br before blocks inside p
  html = html.replace(/<p class="md-p">(<br>\s*)+(<ul|<ol|<blockquote|<pre|<hr)/g, '$2')
  // Collapse repeated br
  html = html.replace(/(<br>\s*){2,}/g, '<br>')
  // Strip br between block end and next p/div
  html = html.replace(/(<\/ol>|<\/ul>|<\/blockquote>)<br>(<p|<div)/g, '$1$2')

  // Continue ol numbering across split single-item lists
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    // results may be dict keyed by platform_agent
...
const submitSurvey = async () => {
  ...
  addLog(`Sending questionnaire to ${selectedAgents.value.size} agent(s)...`)
  ...
  try {
    ...
    addLog(`Questionnaire send failed: ${err.message}`)
  } finally {
...
/* Continuous ol numbering via CSS counter */
.message-text {
