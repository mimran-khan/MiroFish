...
/**
 * Stream agent profiles while generation is in progress
 * @param {string} simulationId
 * @param {string} platform - 'reddit' | 'twitter'
 */
...
/**
 * Stream simulation config while generation is in progress
 * @param {string} simulationId
 * @returns {Promise} Config payload including metadata and config body
 */
...
/**
 * Tear down simulation environment (graceful shutdown)
 ...
 * Used for the home page history list
